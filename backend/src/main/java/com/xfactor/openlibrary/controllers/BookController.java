...
public class BookController { 
    ...
    @GetMapping("/bookbypublisherandcategory/{publisher}/{category}")
    public List<Book> getBookByPublisherAndCategory(@PathVariable String publisher,@PathVariable String category)
    {
        return bookRepository.findByPublisherAndCategory(publisher,category); 
    }
